...
namespace HelloAssetAdministrationShell
{
    public class HelloAssetAdministrationShellService : AssetAdministrationShellServiceProvider
    {
        ...
        {
            AssetAdministrationShell aas = new AssetAdministrationShell("Basyx", new BaSyxShellIdentifier("Basyx", "1.0.0"))
            {
            ...
            GERVALUE get = new GERVALUE();
            var va = Task.Run(()=>get.GETval()).Result;
            Console.WriteLine(va);
            int e =0;
            foreach(var i in va)
            {   e++;
                int valueTemperature = i.ID;
                Console.WriteLine(valueTemperature);
                Console.WriteLine(e);

               
                helloSubmodel.SubmodelElements.Add(item: new SubmodelElementCollection("Timeseriesdata"+e.ToString()){
                     Description = new LangStringSet(){new LangString("en","this is a collection")},
                    IdShort = "TimeSeries"+e.ToString(),
                    Value ={
                    new Property<int>("ID",i.ID){
                       Description = new LangStringSet(){new LangString("en","this is a collection")},
                       IdShort = "ID"

                    },
                    new Property<string>("Timestamp"+e,i.TimeStamp){
                     Description = new LangStringSet(){new LangString("en","this is a collection")},
                       IdShort = "TimeStamp"

                },
                     new Property<double>("Value"+e,i.Value){
                       Description = new LangStringSet(){new LangString("en","this is a collection")},
                       IdShort = "Value"
          ...
          /*  helloSubmodel.SubmodelElements = new ElementContainer<ISubmodelElement>();
            helloSubmodel.SubmodelElements.Add(new Property<string>("HelloProperty", "Timeseries")
            {
            ...
            // new submodel collection starts here 
          helloSubmodel.SubmodelElements.Add(item: new SubmodelElementCollection("Timeseriesdata")
            {
                Description = new LangStringSet(){new LangString("en","this is a collection")},
                IdShort = "TimeSeries",
                Value ={
                    new Property<int>("ID",ID){
                       Description = new LangStringSet(){new LangString("en","this is a collection")},
                       IdShort = "ID"

                    },
                    new Property<string>("Timestamp",TimeStamp){
                     Description = new LangStringSet(){new LangString("en","this is a collection")},
                       IdShort = "TimeStamp"

                },
                new Property<double>("Value",.Value){
                       Description = new LangStringSet(){new LangString("en","this is a collection")},
                       IdShort = "Value"
